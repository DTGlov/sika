    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-2xl mx-auto px-4 py-12 md:py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">5. Data storage and security</h2>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">7. Cookies and tracking</h2>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">8. Children</h2>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">9. Changes to this policy</h2>
