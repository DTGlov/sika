...
interface SikaWeeklyBannerProps {
  recapId: string;
}

export function SikaWeeklyBanner({ recapId }: SikaWeeklyBannerProps) {
  ...
  return (
    <div className="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl bg-gradient-to-r from-[#141416] to-[#1C1C1F] border border-[#FBBF24]/20 shadow-[0_0_20px_rgba(251,191,36,0.06)]">
      ...
      >
        ...
        <div>
          <div className="text-sm font-semibold text-[#FAFAFA]">Your week in money is ready</div>
          <div className="text-xs text-[#71717A]">5–7 takeaways from your last 7 days →</div>
        </div>
      </button>
