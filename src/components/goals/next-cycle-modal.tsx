          ...
          >
            <div className="p-5 space-y-4">
              ...
              <p className="text-muted-foreground text-sm">
                ...
                <span className="text-foreground font-medium">{formatGHS(completedGoal.target_amount ?? 0)}</span>.
              ...
              <div className="space-y-3">
                <div>
                  <label className="text-muted-foreground text-xs font-medium block mb-1">Name</label>
                  <input
                    value={name}
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="text-muted-foreground text-xs font-medium block mb-1">Target</label>
                    <input
                      type="number"
                      min="0.01"
                      step="0.01"
                  ...
                  <div>
                    <label className="text-muted-foreground text-xs font-medium block mb-1">Deadline</label>
                    <input
                      type="date"
                      value={deadline}
              ...
              <div className="flex gap-2 pt-1">
                <button
                  onClick={onClose}
                  className="flex-1 h-10 rounded-xl border border-border text-muted-foreground text-sm hover:text-foreground hover:bg-muted transition-colors"
                >
                  Not now
                </button>
                <button
